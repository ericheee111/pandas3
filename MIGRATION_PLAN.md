...
| 60 | `1246018d48` | 性能优化：优化 apply、astype、fillna、take 和 value_counts 核心执行路径 | python-layer | B8-python-layer | partially migrated: row-wise apply cache and object-int64 dense sorted value_counts subsets; remaining astype/fillna/take/Arrow/putmask/nullable-int value_counts pieces still require separate audit | `lib.pyx/.pyi`, `core/algorithms.py`, apply/putmask/take/arrow/generic/internals/series/tests |
