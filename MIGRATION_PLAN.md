...
| 60 | `1246018d48` | 性能优化：优化 apply、astype、fillna、take 和 value_counts 核心执行路径 | python-layer | B8-python-layer | partially migrated: row-wise apply cache, object-int64 and nullable-int dense value_counts, putmask scalar, bool->object take, and Arrow integer fillna subsets; remaining DataFrame astype/fillna pieces require separate pandas3 CoW audit | `lib.pyx/.pyi`, `core/algorithms.py`, apply/putmask/take/arrow/generic/internals/series/tests |
